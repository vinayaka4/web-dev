   ...
   <div className="row">
     ...
     <div className="col-11">
        ...
        <div className="">{post.post}</div>
              ...
              <img  alt="profile" className=" w-100 border-bottom border-secondary rounded "  src={`/images/${post.image}`} height = {340}/>
        ...
        <ul className="nav   align-items-center nav-justified mt-2 p-0">
          <li className="nav-item">
            <a className="nav-link text-muted" href="https://www.lipsum.com"><i className="bi bi-chat text-muted"></i>  {post.comments}</a>
          </li>
          <li className="nav-item">
            <a className="nav-link text-muted"href="https://www.lipsum.com"><i className="bi bi-heart text-muted"></i> {post.retuits}</a>
          </li>
          <li className="nav-item">
            <a className="nav-link text-muted" href="https://www.lipsum.com"><i className="bi bi-arrow-repeat text-muted"></i> {post.likes}</a>
          </li>
          <li className="nav-item">
         ...
         <div >
         <a className="fw-bold text-primary text-decoration-none" href="https://www.lipsum.com"> {post.show} </a> 
        </div>
    </div>
   </div>
